            ...
            <div class="row align-items-center">
                <div class="col-sm-6">
                    <div class="page-title-box">
                        <h4 class="font-size-18">State</h4>
                ...
                <div class="col-sm-6">
                    <div class="float-right">
                        <a href="add_state" class="btn btn-primary waves-effect waves-light">
                            <i class="mdi mdi-plus mr-2"></i> Add State
                        </a>
                    </div>
                </div>
            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>@if($res->is_active=='active')
                                            <button class="btn btn-success  waves-effect waves-light"
                                                onclick="change_state_status({{ $res->id }},'inactive');">
                                                Active</button>
                                            @else
                                            <button class="btn btn-danger  waves-effect waves-light"
                                                onclick="change_state_status({{ $res->id }},'active');">
                                                Inactive</button>
                                            @endif
                                        </td>
                                        <td align="center"><a href="edit_state/{{ $res->id }}"
    ...
    function change_state_status(id, status) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location = "{{ url('/change_state_status')}}" + '/' +
                    id + '/' + status + '/';
            }
        });
    }
