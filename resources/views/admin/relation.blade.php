            ...
            <div class="row align-items-center">
                <div class="col-sm-6">
                    <div class="page-title-box">
                        <h4 class="font-size-18">Relation</h4>
                ...
                <div class="col-sm-6">
                    <div class="float-right">
                        <a href="add_relation" class="btn btn-primary waves-effect waves-light">
                            <i class="mdi mdi-plus mr-2"></i> Add Relation
                        </a>
                    </div>
                </div>
            </div>
                            ...
                            <table id="admin_table" class="table table-bordered dt-responsive nowrap"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td align="center"><a href="edit_relation/{{ $res->id }}"
    ...
    function change_status(id, status) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location = "{{ url('/change_relation_status')}}" + '/' +
                    id + '/' + status + '/';
            }
        });
    }
